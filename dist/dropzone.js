...
var esnext_iterator_drop = __webpack_require__(7124);
...
var esnext_typed_array_at = __webpack_require__(1839);
  ...
  addedfile: function addedfile(file) {
    ...
    if (this.previewsContainer && !this.options.disablePreviews) {
      ...
      if (this.options.addRemoveLinks) {
        file._removeLink = Dropzone.createElement("<button class=\"dz-remove\" href=\"javascript:undefined;\" data-dz-remove>".concat(this.options.dictRemoveFile, "</button>"));
        file._removeLink.setAttribute("aria-label", "".concat(this.options.dictRemoveFile, ": ").concat(file.name));
...
function dropzone_createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = dropzone_unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t.return || t.return(); } finally { if (u) throw o; } } }; }
function dropzone_unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return dropzone_arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? dropzone_arrayLikeToArray(r, a) : void 0; } }
function dropzone_arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
...
function _possibleConstructorReturn(t, e) { if (e && ("object" == dropzone_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return _assertThisInitialized(t); }
...
var Dropzone = /*#__PURE__*/function (_Emitter) {
  function Dropzone(el, options) {
    ...
    if (_this.options.forceFallback || !Dropzone.isBrowserSupported()) {
      return _possibleConstructorReturn(_this, _this.options.fallback.call(_this));
    }
  ...
  return dropzone_createClass(Dropzone, [{
    ...
    value: function init() {
      ...
      if (this.clickableElements.length) {
        var _setupHiddenFileInput = function setupHiddenFileInput() {
    ...
    value: function _addFilesFromDirectory(directory, path) {
      ...
      var _readEntries = function readEntries() {
    ...
    value: function resizeImage(file, width, height, resizeMethod, callback) {
      ...
      return this.createThumbnail(file, width, height, resizeMethod, true, function (dataUrl, canvas) {
        if (canvas == null) {
          ...
          var resizeMimeType = _this0.options.resizeMimeType;
          if (resizeMimeType == null) {
            resizeMimeType = file.type;
          }
          var resizedDataURL = canvas.toDataURL(resizeMimeType, _this0.options.resizeQuality);
    ...
    value: function createThumbnail(file, width, height, resizeMethod, fixOrientation, callback) {
      ...
      fileReader.onload = function () {
        ...
        _this1.createThumbnailFromUrl(file, width, height, resizeMethod, fixOrientation, callback);
      };
    ...
    value: function displayExistingFile(mockFile, imageUrl, callback, crossOrigin) {
      ...
      if (!resizeThumbnail) {
        ...
        var onDone = function onDone(thumbnail) {
          _this10.emit("thumbnail", mockFile, thumbnail);
          if (callback) callback();
        };
    ...
    value: function createThumbnailFromUrl(file, width, height, resizeMethod, fixOrientation, callback, crossOrigin) {
      ...
      img.onload = function () {
        ...
        return loadExif(function (orientation) {
          ...
          var resizeInfo = _this11.options.resize.call(_this11, file, width, height, resizeMethod);
    ...
    value: function processFiles(files) {
      var _iterator0 = dropzone_createForOfIteratorHelper(files, true),
        _step0;
      try {
        for (_iterator0.s(); !(_step0 = _iterator0.n()).done;) {
          var file = _step0.value;
    ...
    value: function cancelUpload(file) {
      if (file.status === Dropzone.UPLOADING) {
        ...
        var _iterator1 = dropzone_createForOfIteratorHelper(groupedFiles, true),
          _step1;
        try {
        ...
        var _iterator10 = dropzone_createForOfIteratorHelper(groupedFiles, true),
          _step10;
        try {
          for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {
            var _groupedFile = _step10.value;
    ...
    value: function uploadFiles(files) {
      ...
      this._transformFiles(files, function (transformedFiles) {
        if (_this12.options.chunking) {
          // Chunking is not allowed to be used with `uploadMultiple` so we know
          // that there is only __one__file.
          var transformedFile = transformedFiles[0];
          files[0].upload.chunked = _this12.options.chunking && (_this12.options.forceChunking || transformedFile.size > _this12.options.chunkSize);
          files[0].upload.totalChunkCount = Math.ceil(transformedFile.size / _this12.options.chunkSize);
        }
        if (files[0].upload.chunked) {
          ...
          var handleNextChunk = function handleNextChunk() {
            ...
            startedChunkCount++;
            var start = chunkIndex * _this12.options.chunkSize;
            var end = Math.min(start + _this12.options.chunkSize, _transformedFile.size);
            var dataBlock = {
              name: _this12._getParamName(0),
            ...
            _this12._uploadData(files, [dataBlock]);
          };
          file.upload.finishedChunkUpload = function (chunk, response) {
            ...
            if (allFinished) {
              _this12.options.chunksUploaded(file, function () {
                _this12._finished(files, response, null);
              });
            }
          };
          if (_this12.options.parallelChunkUploads) {
            for (var i = 0; i < file.upload.totalChunkCount; i++) {
              handleNextChunk();
            }
          } else {
          ...
          for (var _i2 = 0; _i2 < files.length; _i2++) {
            dataBlocks[_i2] = {
              name: _this12._getParamName(_i2),
              data: transformedFiles[_i2],
              filename: files[_i2].upload.filename
            };
          }
          _this12._uploadData(files, dataBlocks);
        }
      });
    }
    ...
    value: function _uploadData(files, dataBlocks) {
      ...
      var _iterator11 = dropzone_createForOfIteratorHelper(files, true),
        _step11;
      try {
      ...
      xhr.onload = function (e) {
        _this13._finishedUploading(files, xhr, e);
      };
      xhr.ontimeout = function () {
        _this13._handleUploadError(files, xhr, "Request timedout after ".concat(_this13.options.timeout / 1000, " seconds"));
      };
      xhr.onerror = function () {
        _this13._handleUploadError(files, xhr);
      };

      // Some browsers do not have the .upload property
      var progressObj = xhr.upload != null ? xhr.upload : xhr;
      progressObj.onprogress = function (e) {
        return _this13._updateFilesUploadProgress(files, xhr, e);
      };
      var headers = {
      ...
      var _iterator12 = dropzone_createForOfIteratorHelper(files, true),
        _step12;
      try {
        for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
          var _file = _step12.value;
    ...
    value: function _transformFiles(files, done) {
      ...
      var _loop = function _loop(i) {
        _this14.options.transformFile.call(_this14, files[i], function (transformedFile) {
    ...
    value: function _addFormElementData(formData) {
      ...
      if (this.element.tagName === "FORM") {
        var _iterator13 = dropzone_createForOfIteratorHelper(this.element.querySelectorAll("input, textarea, select, button"), true),
          _step13;
        try {
          for (_iterator13.s(); !(_step13 = _iterator13.n()).done;) {
            ...
            if (input.tagName === "SELECT" && input.hasAttribute("multiple")) {
              ...
              var _iterator14 = dropzone_createForOfIteratorHelper(input.options, true),
                _step14;
              try {
    ...
    value: function _updateFilesUploadProgress(files, xhr, e) {
      if (!files[0].upload.chunked) {
        ...
        var _iterator15 = dropzone_createForOfIteratorHelper(files, true),
          _step15;
        try {
    ...
    value: function _finished(files, responseText, e) {
      var _iterator16 = dropzone_createForOfIteratorHelper(files, true),
        _step16;
      try {
...
Dropzone.discover = function () {
  ...
  if (document.querySelectorAll) {
    ...
    var checkElements = function checkElements(elements) {
      return function () {
        var result = [];
        var _iterator18 = dropzone_createForOfIteratorHelper(elements, true),
          _step18;
        try {
  ...
  return function () {
    var result = [];
    var _iterator19 = dropzone_createForOfIteratorHelper(dropzones, true),
      _step19;
    try {
      for (_iterator19.s(); !(_step19 = _iterator19.n()).done;) {
        var dropzone = _step19.value;
...
Dropzone.isBrowserSupported = function () {
  ...
  if (window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector) {
    if (!("classList" in document.createElement("a"))) {
      ...
      var _iterator20 = dropzone_createForOfIteratorHelper(Dropzone.blockedBrowsers, true),
        _step20;
      try {
...
Dropzone.getElements = function (els, name) {
  ...
  if (els instanceof Array) {
    elements = [];
    try {
      var _iterator21 = dropzone_createForOfIteratorHelper(els, true),
        _step21;
      try {
    ...
    elements = [];
    var _iterator22 = dropzone_createForOfIteratorHelper(document.querySelectorAll(els), true),
      _step22;
    try {
...
Dropzone.isValidFile = function (file, acceptedFiles) {
  ...
  var _iterator23 = dropzone_createForOfIteratorHelper(acceptedFiles, true),
    _step23;
  try {
    for (_iterator23.s(); !(_step23 = _iterator23.n()).done;) {
      var validType = _step23.value;
...
var ExifRestore = /*#__PURE__*/function () {
  ...
  return dropzone_createClass(ExifRestore, null, [{
    key: "initClass",
    value: function initClass() {
