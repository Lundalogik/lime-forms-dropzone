    ...
    addedfile (file) {
        ...
        if (this.previewsContainer && !this.options.disablePreviews) {
            ...
            if (this.options.addRemoveLinks) {
                file._removeLink = (0, $3ed269f2f0fb224b$export$2e2bcd8739ae039).createElement(`<button class="dz-remove" href="javascript:undefined;" data-dz-remove>${this.options.dictRemoveFile}</button>`);
